...
class SkillsetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skillset" do
    assert_difference('Skillset.count') do
      post skillsets_url, params: { skillset: { code: @skillset.code, hours_studied: @skillset.hours_studied, skill: @skillset.skill } }
    end
  ...
  test "should update skillset" do
    patch skillset_url(@skillset), params: { skillset: { code: @skillset.code, hours_studied: @skillset.hours_studied, skill: @skillset.skill } }
